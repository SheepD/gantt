...
/***/ function(module, exports, __webpack_require__) {
	...
	var _snapsvgCjs = __webpack_require__(127);
	...
	function Gantt(element, tasks) {
		...
		function prepare_canvas() {
			...
			self.canvas = (0, _snapsvgCjs2.default)(self.element).addClass('gantt');
		}
		...
		function make_grid_ticks() {
			...
			try {
				for (var _iterator6 = self.dates[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
					...
					self.canvas.path(_snapsvgCjs2.default.format('M {x} {y} v {height}', {
						x: tick_x,
						y: tick_y,
						height: tick_height
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.eve = __webpack_require__(128)
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Bar(gt, task) {
		...
		function prepare_plugins() {
			_snapsvgCjs2.default.plugin(function (Snap, Element, Paper, global, Fragment) {
		...
		function show_details() {
			...
			if (!self.details_box) {
				...
				var f = gt.canvas.filter(_snapsvgCjs2.default.filter.shadow(0, 1, 1, '#666', 0.6));
		...
		function render_details() {
			...
			var foreign_object = _snapsvgCjs2.default.parse('<foreignObject width="5000" height="2000">\n\t\t\t\t<body xmlns="http://www.w3.org/1999/xhtml">\n\t\t\t\t\t' + html + '\n\t\t\t\t</body>\n\t\t\t\t</foreignObject>');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Arrow(gt, from_task, to_task) {
		...
		function prepare() {
			...
			self.path = _snapsvgCjs2.default.format('M {start_x} {start_y} V {offset} ' + 'a {curve} {curve} 0 0 {clockwise} {curve} {curve_y} ' + 'L {end_x} {end_y} m -5 -5 l 5 5 l -5 5', {
			...
			if (to_task.$bar.getX() < from_task.$bar.getX() + gt.config.padding) {
				self.path = _snapsvgCjs2.default.format('M {start_x} {start_y} v {down_1} ' + 'a {curve} {curve} 0 0 1 -{curve} {curve} H {left} ' + 'a {curve} {curve} 0 0 {clockwise} -{curve} {curve_y} V {down_2} ' + 'a {curve} {curve} 0 0 {clockwise} {curve} {curve_y} ' + 'L {end_x} {end_y} m -5 -5 l 5 5 l -5 5', {
					start_x: self.start_x,
					start_y: self.start_y,
					end_x: self.end_x,
					end_y: self.end_y,
